...
solveto_img = sg.Image('images/_solid.png', size=(60, 60), key='__SOLVETOIMG__')
col_left = sg.Column([
    [sg.Sizer(200, 10)],
    [sg.Text('1.'), sg.Button('Scan Cube', size=(11, 1))],
    [sg.Text('2.'), sg.Combo(list(PATTERNS.keys()), default_value='Solid Cube', size=(10,2),key='__SOLVETO__')],
